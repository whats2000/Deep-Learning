# Copyright (c) 2023 BobLiu20
# The following code is derived from the YOLOv3 implementation by BobLiu20 available at
# https://github.com/BobLiu20/YOLOv3_PyTorch
import torch
import torch.nn as nn
from collections import OrderedDict
from src_yolo_v3.params import config

from src_yolo_v3 import darknet
...
class ModelMain(nn.Module):
    ...
    def forward(self, x):
        ...
        out0 = out0.reshape(out0.shape[0], 3, 25, out0.shape[2], out0.shape[3]).permute(0, 1, 3, 4, 2)
        out1 = out1.reshape(out1.shape[0], 3, 25, out1.shape[2], out1.shape[3]).permute(0, 1, 3, 4, 2)
        out2 = out2.reshape(out2.shape[0], 3, 25, out2.shape[2], out2.shape[3]).permute(0, 1, 3, 4, 2)
